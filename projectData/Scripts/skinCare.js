...
//********FUNCTION TO FETCH JSON DATA ****** */
    ...
    async function getTechProducts() {
        let displayPage="Skincare";
        if(displayPage == 'Skincare'){
            let response = await fetch("../jsondata/Skincare _ bluemercury.json");
            SkinCare = await response.json();
        }
        else if(displayPage == 'Makeup'){
            let response = await fetch("../jsondata/Shop All Makeup _ bluemercury.json");
            SkinCare = await response.json();
        }
        else if(displayPage == 'Fragrance'){
            let response = await fetch("../jsondata/Fragrances _ bluemercury.json");
            SkinCare = await response.json();
        }
        else if(displayPage == 'Bath & Body'){
            let response = await fetch("../jsondata/Shop All Products For Men _ bluemercury.json");
            SkinCare = await response.json();
        }
        else if(displayPage == 'Hair & Care'){
            let response = await fetch("../jsondata/Hair Care _ bluemercury.json");
            SkinCare = await response.json();
        }
        else if(displayPage == 'Mens'){
            let response = await fetch("../jsondata/Shop All Products For Men _ bluemercury.json");
            SkinCare = await response.json();
        }
        else if(displayPage == 'Suncare'){
            let response = await fetch("../jsondata/Sun Care _ bluemercury.json");
            SkinCare = await response.json();
        }
